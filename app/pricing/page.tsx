...
export default function PricingPage() {
  ...
  const fallback = useMemo(() => ({
    ...
    'subscription.subtitle': 'Choose the perfect plan for your journey to meaningful connections',
    ...
    'subscription.goodDeedPaymentDesc': 'Pay it forward with acts of kindness',
    'subscription.goodDeedTitle': 'Or Pay With Good Deeds',
    'subscription.goodDeedDescription': 'Contribute to the community through acts of kindness instead of traditional payment',
    'subscription.goodDeedOptions': 'Help others, volunteer, or perform verified acts of kindness',
    'subscription.payWithGoodDeeds': 'Pay With Good Deeds',
    'subscription.freeForNow': 'All features are currently free during our beta period',
          ...
          <div className="min-h-screen bg-gradient-subtle">
            <div className="container mx-auto px-4 py-16">
              <div className="text-center mb-12">
                ...
                <h1 className="text-4xl font-bold mb-4">{getText('subscription.title')}</h1>
                        ...
                        <div className="mt-4">
                          <div className="flex items-baseline gap-1">
                            ...
                            <span className="text-muted-foreground">
                              /{isAnnual ? getText('subscription.year') : getText('subscription.month')}
                            </span>
                          </div>
                          {isAnnual && (
              ...
              <div className="max-w-2xl mx-auto">
                <Card className="border-dashed border-2 border-sky-100/50 bg-sky-100/50">
                  <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-xl">{getText('subscription.goodDeedTitle')}</CardTitle>
                    <CardDescription>
