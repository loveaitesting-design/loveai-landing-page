...
//                     <div className="w-12 h-6 bg-sky-400 rounded-full relative cursor-pointer">
...
//   {/* Accept All */}
//   <button className="flex items-center gap-2 bg-sky-400 text-white px-8 py-3 rounded-2xl font-medium hover:bg-sky-600 transition-colors">
//     <CheckCircle2 className="w-5 h-5" />
//     {getTranslatedText('cookie_policy.buttons.accept_all', 'Accept All')}
//   </button>

//   {/* Reject Optional */}
//   <button className="flex items-center gap-2 border-2 border-sky-400 text-sky-400 px-8 py-3 rounded-2xl font-medium hover:bg-sky-600 hover:text-white transition-colors">
//     <CircleSlash className="w-5 h-5" />
//     {getTranslatedText('cookie_policy.buttons.reject_optional', 'Reject Optional')}
//   </button>

//   {/* Save Settings */}
//   <button className="flex items-center gap-2 bg-[#AEEBFF] text-[#027D9D] px-8 py-3 rounded-2xl font-medium hover:bg-sky-600 hover:text-white transition-colors">
          ...
          <div className="border-[20px] border-sky-400 rounded-2xl p-6 max-w-6xl mx-auto bg-white/60 backdrop-blur-sm mt-[46px] mb-[46px]">
            ...
            <div className="space-y-[40px]">
              ...
              <div className="mt-8 p-4 bg-gray-100 rounded-lg">
                <h3 className="font-bold mb-2">Current Cookie Settings (Debug):</h3>
                <pre className="text-sm">{JSON.stringify(cookieSettings, null, 2)}</pre>
              </div>
