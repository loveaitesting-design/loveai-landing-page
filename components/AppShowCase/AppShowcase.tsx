...
import { Heart, Calendar, MapPin, Star, Users, TrendingUp, Smartphone, X } from "lucide-react";
...
const AppShowcase = () => {
  ...
  <div onClick={handleAppStoreClick}
    ...
    className="flex items-center gap-3 bg-black text-white px-6 py-3 rounded-2xl hover:bg-gray-800 transition-colors duration-300 min-w-[200px] cursor-pointer"
  >
