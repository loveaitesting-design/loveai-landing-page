...
const Testimonials = () => {
  ...
  <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-gray-900">
    {language === 'he'
      ? 'זוגות שמצאו אהבה '
      : language === 'ru'
      ? 'Пары, которые нашли любовь '
      : 'Couples who found love '}
    <span className="text-sky-500">10,000+</span>
  </h2>

  <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
    {language === 'he'
      ? 'כל שבוע, אלפי זוגות מתחילים את מסע האהבה שלהם דרך LoveAI. הנה כמה מהסיפורים המדהימים שלהם.'
      : language === 'ru'
      ? 'Каждую неделю тысячи пар начинают свой путь к любви через LoveAI. Вот некоторые из их удивительных историй.'
      : 'Every week, thousands of couples begin their journey of love through LoveAI. Here are some of their amazing stories.'}
  </p>
</div>
